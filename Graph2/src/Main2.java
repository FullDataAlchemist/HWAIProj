...
public class Main2 {
	...
	// private static void reverseCalc() {

	// if (gAArray.size() % 6 >= gBArray.size() % 6 && gAArray.size() % 6 >=
	// gCArray.size() % 6
	// && gAArray.size() % 6 != 0) {
	// } else if (gBArray.size() % 6 >= gAArray.size() % 6 && gBArray.size() % 6 >=
	// gCArray.size() % 6
	// && gBArray.size() % 6 != 0) {
	//
	// } else if (gCArray.size() % 6 >= gAArray.size() % 6 && gCArray.size() % 6 >=
	// gBArray.size() % 6
	// && gCArray.size() % 6 != 0) {
	//
	// }

	// if (gAArray.size() % 6 - 3 =< 0)
	// else if (gBArray.size() % 6 - 3 =< 0)
	// else if (gCArray.size() % 6 - 3 =< 0) {
	// if (gAArray.size() % 6 >= gBArray.size() % 6 && gAArray.size() % 6 >=
	// gCArray.size() % 6
	// && gAArray.size() % 6 != 0) {
	// } else if (gBArray.size() % 6 >= gAArray.size() % 6 && gBArray.size() % 6 >=
